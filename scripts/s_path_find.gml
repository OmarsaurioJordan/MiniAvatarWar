///s_path_find(x, y, grid_result, talla_celda, grid_zona);
// arg0: destino x
// arg1: destino y
// arg2: id grid que hace de camino final
// arg3: talla de la celda
// arg4: id grid de obstaculos

// datos generales de la rejilla
var wmax = ceil(room_width / argument3);
var hmax = ceil(room_height / argument3);
var mx = round(argument0 / argument3);
var my = round(argument1 / argument3);
var zona = argument4;
...
ds_grid_set(zona, round(argument0 / argument3), round(argument1 / argument3), viej);
